        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            <div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden flex flex-col focus-within:ring-1 focus-within:ring-red-600 focus-within:border-red-600 transition-all">
                ...
                <div className="bg-gray-50 border-b border-gray-200 px-3 py-2 flex items-center gap-1 flex-wrap">
                  <button className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200 rounded transition-colors" title="Bold">
                    <Bold size={16} />
                  </button>
                  <button className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200 rounded transition-colors" title="Italic">
                    <Italic size={16} />
                  </button>
                  <div className="w-px h-5 bg-gray-300 mx-1"></div>
                  <button className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200 rounded transition-colors" title="Bullet List">
                    <List size={16} />
                  </button>
                  <div className="w-px h-5 bg-gray-300 mx-1"></div>
                  <button className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200 rounded transition-colors" title="Link">
                    <Link2 size={16} />
                  </button>
                  <button className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200 rounded transition-colors" title="Image">
                    <ImageIcon size={16} />
                  </button>
                </div>
                {/* Editor Area */}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-red-400 hover:bg-red-50/30 transition-colors cursor-pointer group group-focus-within:border-red-600">
            ...
            <div>
              ...
              <select className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-black focus:outline-none focus:ring-1 focus:ring-red-600 focus:border-red-600 transition-all appearance-none cursor-pointer">
